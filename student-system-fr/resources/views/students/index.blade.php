...
<head>
    ...
    <title>Laravel + Framework7</title>
...
<div class="block-title">
                    <h2>Student Management System from Laravel & Framework7</h2>
                </div>
    <table id="studentTable">
        <thead>
            ...
            <tr class="search-row">
                ...
                <td colspan="2"><button onclick="searchStudents()" class="search-button">Search</button></td>
            ...
            <tr class="add-row">
                ...
                <td colspan="2"><button onclick="createStudent()" class="search-button">Add</button></td>
            </tr>
        </thead>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/framework7/7.1.5/js/framework7.bundle.min.js"></script>
    <script>
    ...
    const app = new Framework7({
      ...
      id: 'com.studentmanagementsystem',
      theme: 'auto',
        });
        let currentPage = 1;
        let sortColumn = 0;
        ...
        function displayStudents(students) {
            ...
            students.forEach(student => {
                ...
                row.innerHTML = `
                    ...
                    <td> <button onclick="toggleUpdate(${student.sid})">Edit</button></td>
                    <td> <button onclick="deleteStudent(${student.sid})">Delete</button> </td>
                `;
